...
const skillData = {
    ...
    cst: {
        ...
        app: "6G THz-band microstrip patch antenna research, KSCST-funded, published as first author in IJNRD (2024)."
    },
    kicad: {
...
[PUBLICATIONS & AWARDS]
- Publication: "Design of 6G Antenna," IJNRD 2024, Vol. 9 Issue 6 (first author, KSCST-funded).
...
- **Publication (First Author)**: "Design of 6G Antenna," IJNRD 2024, Vol. 9 Issue 6. KSCST-funded project.
...
function runHwAlignmentDiagnostics() {
    ...
    const lines = [
        ...
        "Verifying electromagnetics research files... FOUND [IJNRD 2024 antenna publication, first author, KSCST-funded]",
